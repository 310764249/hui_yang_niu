...
class WeanDetailView extends GetView<WeanDetailController> {
  const WeanDetailView({Key? key}) : super(key: key);
  @override
    ...
    Widget _operationInfo(context) {
      return MyCard(children: [
        ...
        CellButtonDetail(
          isRequired: true,
          title: '育肥牛批次',
          hint: controller.event!.batchNo ?? Constant.placeholder,
        ),
        CellButtonDetail(
          isRequired: false,
          title: '总重量（kg）',
