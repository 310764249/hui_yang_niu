...
class EnvironmentAssessDetailView extends GetView<EnvironmentAssessDetailController> {
  const EnvironmentAssessDetailView({Key? key}) : super(key: key);
    ...
    return MyCard(children: [
      ...
      CellButtonDetail(
        ...
        hint: AppDictList.findLabelByCode(
            controller.environmentAssessList, controller.event!.status.toString()),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
