...
class PregcyDetailView extends GetView<PregcyDetailController> {
  const PregcyDetailView({Key? key}) : super(key: key);
      ...
      return MyCard(children: [
        ...
        CellButtonDetail(
          ...
          hint: AppDictList.findLabelByCode(
              controller.passList, controller.event!.result.toString()),
        ),
        CellButtonDetail(
          isRequired: false,
          title: '操作人',
