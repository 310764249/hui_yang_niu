...
import '../../../../modules/material_management/select_material_view.dart';
        ...
        children: [
          ...
          controller.typeIndex.value == 0
              ...
              : CellButton(
                ...
                onPressed: () {
                  Get.toNamed(
                    Routes.CATTLELIST,
                    arguments: CattleListArgument(goBack: true, single: true),
                  )?.then((value) {
                    ...
                    controller.cowHouse?.value = matchCowHouseById(
                      list.first.cowHouseId,
                    );
                  });
                },
              ),
          ...
          CellButton(
            ...
            onPressed: () {
              Picker.showDatePicker(
                context,
                title: '请选择时间',
                selectDate: controller.preventionTime.value,
                onConfirm: (date) {
          ...
          CellButton(
            ...
            onPressed: () {
              Picker.showSinglePicker(
                context,
                controller.loimiaNameList,
                selectData: controller.loimia.value,
                title: '请选择疫病',
                onConfirm: (value, position) {
                  controller.loimiaId = int.parse(
                    controller.loimiaList[position]['value'],
                  );
