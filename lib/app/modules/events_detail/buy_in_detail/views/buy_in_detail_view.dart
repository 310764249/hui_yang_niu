...
class BuyInDetailView extends GetView<BuyInDetailController> {
  const BuyInDetailView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            colors: controller.event!.gender == 2
          ...
          Row(mainAxisSize: MainAxisSize.max, children: [
            ...
            Expanded(
              child: Column(
                  ...
                  children: [
                    Text(controller.event!.batchNo.orEmpty(),
                        style: TextStyle(
                            color: controller.event!.gender == 2
                      ...
                      child: ListView(
                        ...
                        children: [
                          _labelView(AppDictList.findLabelByCode(
                              controller.gmList,
                              controller.event!.gender.toString())),
                          SizedBox(width: ScreenAdapter.width(2)),
                          _labelView('${controller.event!.cowHouseName}'),
                        ],
                      ),
                    )
                  ]),
    ...
    Widget _operationInfo(context) {
      return MyCard(children: [
        ...
        //   isRequired: true,
        //   title: '引种数量',
        //   hint: controller.event!.co,
        // ),
        CellButtonDetail(
          isRequired: false,
          title: '来源场',
          hint: controller.event!.sourceFarm,
        ),
        CellButtonDetail(
          isRequired: true,
          title: '入场时间',
          hint: controller.event!.inArea ?? Constant.placeholder,
        ),
        CellButtonDetail(
          isRequired: true,
          title: '出生时间',
          hint: controller.event!.birth ?? Constant.placeholder,
        ),
        CellButtonDetail(
          isRequired: true,
          title: '性别',
          hint: AppDictList.findLabelByCode(
              controller.gmList, controller.event!.gender.toString()),
        ),
        CellButtonDetail(
          isRequired: true,
          title: '品种',
        ...
        CellButtonDetail(
          isRequired: true,
          title: '栋舍',
          hint: controller.event!.cowHouseName ?? Constant.placeholder,
        ),
        CellButtonDetail(
          isRequired: false,
          title: '操作人',
