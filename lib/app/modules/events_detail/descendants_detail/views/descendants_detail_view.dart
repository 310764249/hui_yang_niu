...
class DescendantsDetailView extends GetView<DescendantsDetailController> {
  const DescendantsDetailView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    return MyCard(children: [
      ...
      CellButtonDetail(
        isRequired: true,
        title: '母牛耳号',
        hint: controller.event!.maternalCowCode,
      ),
      CellButtonDetail(
        isRequired: true,
        title: '犊牛耳号',
        hint: controller.event!.code,
      ),
      CellButtonDetail(
        isRequired: true,
        title: '出生日期',
