  ...
  Future<AudioContext> _getAudioContext() async {
    ...
    return AudioContext(
      android: AudioContextAndroid(
        usageType: isSpeakerphoneOn ? AndroidUsageType.media : AndroidUsageType.voiceCommunication,
        audioMode: isSpeakerphoneOn ? AndroidAudioMode.normal : AndroidAudioMode.inCommunication,
