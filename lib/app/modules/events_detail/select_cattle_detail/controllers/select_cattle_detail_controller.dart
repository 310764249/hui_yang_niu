...
class SelectCattleDetailController extends GetxController {
  //TODO: Implement SelectCattleDetailController
  ...
  Future<void> getCattleEvent(String businessId) async {
    try {
      var response = await httpsClient.get(
        "/api/selstock/$businessId",
      );
      event = SelectEvent.fromJson(response);
    } catch (error) {
      Toast.dismiss();
