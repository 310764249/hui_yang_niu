...
class HealthAssessDetailView extends GetView<HealthAssessDetailController> {
  const HealthAssessDetailView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    return MyCard(children: [
      ...
      CellButtonDetail(
        isRequired: true,
        title: '耳号',
        hint: controller.event!.cowCode ?? Constant.placeholder,
      ),
      CellButtonDetail(
        isRequired: true,
        title: '评估日期',
      ...
      CellButtonDetail(
        isRequired: true,
        title: '日龄',
        hint: controller.event!.ageOfDay.toString(),
      ),
      CellButtonDetail(
        isRequired: true,
        title: '胎次',
        hint: controller.event!.calvNum.toString(),
      ),
      CellButtonDetail(
        isRequired: true,
        title: '历次疾病名称',
        hint: controller.event!.illness,
      ),
      CellButtonDetail(
        isRequired: true,
        title: '诊疗次数',
        hint: controller.event!.treatCount.toString(),
      ),
      CellButtonDetail(
        isRequired: true,
        title: '健康评估',
        hint: AppDictList.findLabelByCode(
            controller.bodyAssessList, controller.event!.state.toString()),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
