...
class CustomChatRoomMessagesWidget extends StatefulWidget {
  ...
  final Widget? Function(BuildContext content, Message msg, ChatUIKitProfile? user)? itemBuilder;
  final void Function(BuildContext content, Message msg, ChatUIKitProfile? user)? onTap;
  final void Function(BuildContext content, Message msg, ChatUIKitProfile? user)? onLongPress;
...
class _CustomChatRoomMessagesWidgetState extends State<CustomChatRoomMessagesWidget>
  ...
  Widget themeBuilder(BuildContext context, ChatUIKitTheme theme) {
    ...
    content = Stack(children: [content, Positioned(bottom: 0, child: unreadCountWidget())]);
  ...
  @override
  onMessagesRecalledInfo(List<RecallMessageInfo> infos, List<Message> replaces) {
