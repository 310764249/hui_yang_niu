...
class BreedValueDetailView extends GetView<BreedValueDetailController> {
  const BreedValueDetailView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo() {
    return MyCard(children: [
      ...
      CellButtonDetail(
        isRequired: true,
        title: '育种值',
        hint: controller.event!.value.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '平均育种值',
        hint: controller.event!.avgValue?.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '数据来源',
        hint: controller.event!.source,
      ),
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
