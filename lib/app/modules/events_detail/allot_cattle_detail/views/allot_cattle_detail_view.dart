...
class AllotCattleDetailView extends GetView<AllotCattleDetailController> {
  const AllotCattleDetailView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    return MyCard(children: [
      ...
      CellButtonDetail(
        isRequired: true,
        title: '接收场',
        hint: controller.event!.inFarmName,
      ),
      CellButtonDetail(
        isRequired: true,
        title: '接收栋舍',
