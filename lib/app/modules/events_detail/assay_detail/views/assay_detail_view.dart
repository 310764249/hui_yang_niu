...
class AssayDetailView extends GetView<AssayDetailController> {
  const AssayDetailView({Key? key}) : super(key: key);
    ...
    return MyCard(children: [
      ...
      CellButtonDetail(
        ...
        hint: AppDictList.findLabelByCode(
            controller.cdList, controller.event!.result.toString()),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '技术员',
