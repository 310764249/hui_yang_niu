...
class BreedValueView extends GetView<BreedValueController> {
  const BreedValueView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    return MyCard(children: [
      ...
      CellTextField(
        ...
        hint: '请输入',
        keyboardType: const TextInputType.numberWithOptions(decimal: true),
        controller: controller.averageEstimateController,
        focusNode: controller.averageEstimateNode,
      ),
      CellTextField(
        isRequired: false,
        title: '数据来源',
