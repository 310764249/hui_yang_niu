...
class InbreedingDetailsView extends GetView<InbreedingDetailsController> {
  const InbreedingDetailsView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    return MyCard(children: [
      ...
      CellButtonDetail(
        isRequired: true,
        title: '公牛耳号',
        hint: controller.event!.maleCowCode ?? Constant.placeholder,
      ),
      CellButtonDetail(
        isRequired: true,
        title: '近交系数',
        hint: controller.event!.coefficient.toString(),
      ),
      CellButtonDetail(
        isRequired: true,
        title: '评估时间',
      ...
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
        hint: controller.event!.executor ?? Constant.placeholder,
      ),
      CellTextAreaDetail(
        isRequired: false,
        title: '备注',
