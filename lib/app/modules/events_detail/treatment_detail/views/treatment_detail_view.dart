                    ...
                    children: [
                      _keyValueView(
                        ...
                        AppDictList.findLabelByCode(
                          controller.szjdList,
                          controller.genderCode,
                        ),
                      ),
                      SizedBox(height: ScreenAdapter.height(6)),
                      _keyValueView(
                        '日   龄: ',
                        '${controller.ageOfDay.toString()}天',
                      ),
                    ],
                  ),
                ),
      ...
      children: [
        ...
        CellButtonDetail(
          ...
          hint: AppDictList.findLabelByCode(
            ...
            controller.event!.illness.toString(),
          ),
        ),
        controller.cattle == null
            ? CellButtonDetail(
              isRequired: false,
              title: '头数',
              hint: controller.event?.count?.toString() ?? Constant.placeholder,
            )
            : const SizedBox(),
        CellButtonDetail(
          isRequired: false,
          title: '症状',
          hint: controller.event!.symptom ?? Constant.placeholder,
        ),
        CellButtonDetail(
          isRequired: false,
          title: '用药物资',
        ...
        CellButtonDetail(
          ...
          title: '诊疗人员',
          hint:
              ObjectUtil.isEmpty(controller.event!.treatmentPerson)
                  ? Constant.placeholder
                  : controller.event!.treatmentPerson,
        ),
        CellButtonDetail(
          isRequired: false,
          title: '操作人',
