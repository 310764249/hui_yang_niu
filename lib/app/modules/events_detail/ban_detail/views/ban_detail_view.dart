...
class BanDetailView extends GetView<BanDetailController> {
  const BanDetailView({Key? key}) : super(key: key);
    ...
    Widget _operationInfo(context) {
      return MyCard(children: [
        ...
        CellButtonDetail(
          isRequired: true,
          title: '开始时间',
          hint: controller.event!.startDate,
        ),
        CellButtonDetail(
          isRequired: true,
          title: '结束时间',
          hint: controller.event!.endDate,
        ),
        CellButtonDetail(
          isRequired: true,
          title: '禁配原因',
