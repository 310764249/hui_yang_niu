...
class CalvDetailView extends GetView<CalvDetailController> {
  const CalvDetailView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    return MyCard(children: [
      ...
      CellButtonDetail(
        isRequired: true,
        title: '头数',
        hint: controller.event!.nums.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '总重量',
        hint: controller.event!.weight.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '产护',
        hint: AppDictList.findLabelByCode(
            controller.passList, controller.event!.reason.toString()),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
