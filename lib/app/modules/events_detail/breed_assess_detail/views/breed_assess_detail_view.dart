...
class BreedAssessDetailView extends GetView<BreedAssessDetailController> {
  const BreedAssessDetailView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    print(controller.bodyAssessList);
    return MyCard(children: [
      ...
      CellButtonDetail(
        ...
        hint: AppDictList.findLabelByCode(
            controller.bodyAssessList, controller.event!.status.toString()),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
