...
class PreventionDetailView extends GetView<PreventionDetailController> {
  const PreventionDetailView({Key? key}) : super(key: key);
      ...
      children: [
        ...
        CellButtonDetail(
          ...
          hint: AppDictList.findLabelByCode(
            controller.loimiaList,
            controller.event!.loimia.toString(),
          ),
        ),
        CellButtonDetail(
          isRequired: false,
          ...
          hint: AppDictList.findLabelByCode(
            ...
            controller.event!.vaccine.toString(),
          ),
        ),
        CellButtonDetail(
          isRequired: false,
        ...
        CellButtonDetail(
          ...
          title: '单头剂量',
          hint:
              '${controller.event!.dosage} ${AppDictList.findLabelByCode(controller.unitList, controller.event!.unit?.toString() ?? '')}',
        ),
        CellButtonDetail(
          isRequired: false,
          title: '头数',
