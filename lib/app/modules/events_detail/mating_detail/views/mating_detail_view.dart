...
class MatingDetailView extends GetView<MatingDetailController> {
  const MatingDetailView({Key? key}) : super(key: key);
  //
  ...
  // 本交
  Widget _natureLayout() {
    return Column(
      children: [
        CellButtonDetail(
          isRequired: true,
          title: '配种公牛',
          hint: controller.event!.maleCowCode,
        ),
      ],
    );
  }
    ...
    return Column(
      children: [
        CellButtonDetail(
          isRequired: true,
          title: '精液编号',
          hint: controller.event!.semenNumber,
        ),
        CellButtonDetail(
          isRequired: true,
          title: '精液份数',
          hint: controller.event!.copies.toString(),
        ),
      ],
    );
  }
    ...
    return MyCard(children: [
      ...
      CellButtonDetail(
        ...
        hint: AppDictList.findLabelByCode(
            controller.passList, controller.event!.type.toString()),
      ),
      controller.event!.type == 1 ? _natureLayout() : _humanLayout(),
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
