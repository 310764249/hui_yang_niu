...
class SalesAssessDetailView extends GetView<SalesAssessDetailController> {
  const SalesAssessDetailView({Key? key}) : super(key: key);
    ...
    return MyCard(children: [
      ...
      CellButtonDetail(
        ...
        hint: AppDictList.findLabelByCode(
            controller.bodyAssessList, controller.event!.type.toString()),
      ),
      CellButtonDetail(
        isRequired: true,
        title: '数量',
