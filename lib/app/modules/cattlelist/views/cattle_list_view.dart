                              ...
                              onTap: () {
                                ...
                                if (controller.argument.goBack) {
                                  ...
                                  if (controller.argument.routerStr == null) {
                                    Get.toNamed(Routes.CATTLE_DETAIL,
    ...
    return Shimmer.fromColors(
      ...
      child: Padding(
        ...
        child: GridView.builder(
          ...
          // 数量为: 屏幕高度 / item高度 取整数
          itemCount:
              ScreenAdapter.getScreenHeight() ~/ ScreenAdapter.height(104) * 3,
          itemBuilder: (context, index) {
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                //设置四周圆角 角度
                borderRadius: BorderRadius.all(
                    Radius.circular(ScreenAdapter.height(5.0))),
              ),
            );
          },
        ),
