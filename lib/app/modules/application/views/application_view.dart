      ...
      onTap: () {
        ...
        switch (name) {
          ...
          case '待淘汰数':
            Get.toNamed(
              Routes.EVENT_CATTLE_LIST,
              arguments: EventsCattleListArgument(6, '待淘汰', Routes.KNOCK_OUT),
            );
            break;
          case '待出栏数':
            Get.toNamed(
              Routes.EVENT_CATTLE_LIST,
              arguments: EventsCattleListArgument(7, '待出栏', Routes.SELL_CATTLE),
            );
            break;
          case '待防疫数':
            Get.toNamed(
              Routes.EVENT_CATTLE_LIST,
              arguments: EventsCattleListArgument(9, '待防疫', Routes.PREVENTION),
            );
            break;
          default:
        }
          ...
          children: [
            Expanded(
              child: InkWell(
                onTap: () {
                  ...
                  Get.toNamed(Routes.NEW_CATTLE);
                },
                child: const LoadAssetImage(AssetsImages.fileManagement, fit: BoxFit.fitWidth),
              ),
            ),
            ...
            Expanded(
              child: InkWell(
                ...
                child: const LoadAssetImage(AssetsImages.cattleList, fit: BoxFit.fitWidth),
              ),
            ),
          ],
        ),
        ...
        Row(
          children: [
            ...
            Expanded(
              child: Bounceable(
                onTap: () {
                  Get.toNamed(Routes.BATCH_LIST, arguments: BatchListArgument(goBack: false));
                },
                child: Container(
                  height: ScreenAdapter.height(60),
                  alignment: Alignment.center,
