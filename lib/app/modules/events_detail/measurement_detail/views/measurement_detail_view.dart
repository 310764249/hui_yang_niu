...
class MeasurementDetailView extends GetView<MeasurementDetailController> {
  const MeasurementDetailView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    return MyCard(children: [
      ...
      CellButtonDetail(
        isRequired: false,
        title: '额宽(cm)',
        hint: controller.event!.foreheadSize.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '体长(cm)',
        hint: controller.event!.bodyLen.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '体斜长(cm)',
        hint: controller.event!.bodyDiagonalLen.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '胸宽(cm)',
        hint: controller.event!.chestWide.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '胸深(cm)',
        hint: controller.event!.chestDepth.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '胸围(cm)',
        hint: controller.event!.chest.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '腰角宽(cm)',
        hint: controller.event!.waistline.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '管围(cm)',
        hint: controller.event!.cocbone.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '体重(kg)',
        hint: controller.event!.wight.toString(),
      ),
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
