...
class ApplicationController extends GetxController {
    ...
    if (res != null) {
      ...
      materialManagementList.value =
          isRetailer
              ? []
              : [
                CommonData(id: 0, name: "采购", image: AssetsImages.icon27),
      ...
      benefitAssessmentList.value = [
        ...
        CommonData(id: 3, name: "收支统计", image: Assets.imagesIcIncome),
  ...
  void requestBasicStatistics() async {
    try {
      ...
      //任务统计
      ProductionTaskStatistics productionTaskModel = ProductionTaskStatistics.fromJson(
        productionTask,
      );
