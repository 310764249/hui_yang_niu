        ...
        list.add(
          InkWell(
            ...
            child: Container(
              ...
              child: Text(
                item,
                style: TextStyle(fontSize: ScreenAdapter.fontSize(18), fontWeight: FontWeight.w500),
              ),
            ),
          ),
        );
...
class MultiItem extends StatefulWidget {
  ...
  const MultiItem({super.key, required this.title, this.onChanged, required this.isChecked});
