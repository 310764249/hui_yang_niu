...
class SemenDetailView extends GetView<SemenDetailController> {
  const SemenDetailView({Key? key}) : super(key: key);
  @override
      ...
      return MyCard(children: [
        ...
        CellButtonDetail(
          ...
          hint: AppDictList.findLabelByCode(
              controller.passList, controller.event!.quality.toString()),
        ),
        CellButtonDetail(
          isRequired: false,
          title: '操作人',
