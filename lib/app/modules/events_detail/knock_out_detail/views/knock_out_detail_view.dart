...
class KnockOutDetailView extends GetView<KnockOutDetailController> {
  const KnockOutDetailView({Key? key}) : super(key: key);
  ...
  Widget _operationInfo(context) {
    return MyCard(children: [
      ...
      CellButtonDetail(
        isRequired: true,
        title: '淘汰原因',
        hint: AppDictList.findLabelByCode(controller.reasonList, controller.event!.cause.toString()),
      ),
      CellButtonDetail(
        isRequired: true,
        title: '淘汰时间',
