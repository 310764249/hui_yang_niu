...
import 'package:intellectual_breed/app/widgets/cell_image_detail.dart';
...
class DieCattleDetailView extends GetView<DieCattleDetailController> {
  const DieCattleDetailView({Key? key}) : super(key: key);
    ...
    return MyCard(children: [
      ...
      CellButtonDetail(
        ...
        hint: AppDictList.findLabelByCode(
            controller.reasonList, controller.event!.cause.toString()),
      ),
      CellButtonDetail(
        isRequired: true,
        title: '死亡时间',
      ...
      CellImageDetail(
        isRequired: false,
        title: '上传图片',
        showImgs: controller.imgsList.value,
      ),
      CellButtonDetail(
        isRequired: false,
        title: '操作人',
